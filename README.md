...
已同步 RhineLabUI 网页主线：自由拖动与松手惯性、滚轮切档、自适应阵列、亮暗配色和超级性能模式。性能模式独立于减少动画，关闭后恢复原画质；阅读页共享配色。字体采用固定版本的同源 MiSans 字符分包。

博客依然独立维护内容和阅读路由，不加载 Wallpaper Engine 工作台或宿主功能。此版本尚未启用博客 PWA。上游版本与验证说明见 `migration/UPSTREAM-2026-09-11.md`。
